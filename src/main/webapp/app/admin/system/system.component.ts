...
export class SystemComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.systemService
            ...
            .subscribe(
                (res: HttpResponse<ISystem>) => this.paginateSystems(res.body, res.headers),
    ...
    trackId(index: number, item: ISystem) {
        return item.id;
    }
    ...
    protected paginateSystems(data: ISystem, headers: HttpHeaders) {
        this.systems = data;
    }
