...
public class MyBase32 {
    ...
    ;
    /**
     * Routines for converting between Strings of MyBase32-encoded data and arrays
     * of binary data.  This currently supports the MyBase32 and Base32hex alphabets
    ...
    /**
     * Creates an object that can be used to do MyBase32 conversions.
     *
     * @param alphabet  Which alphabet should be used
     * @param padding   Whether padding should be used
     * @param lowercase Whether lowercase characters should be used.
     *                  default parameters (The standard MyBase32 alphabet, no padding, uppercase)
     */
    MyBase32(String alphabet, boolean padding, boolean lowercase) {
    ...
    /**
     * Convert binary data to a MyBase32-encoded String
     *
    ...
    /**
     * Convert a MyBase32-encoded String to binary data
     *
