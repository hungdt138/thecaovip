...
public class Authentication {
    ...
    /**
     * @author dungvm
     * tao ma otp dua tren thoi gian hien tai va 1 string secret
     *
     * @param secret
     */

    public static String GoogleAuthenticatorCode(@NotNull String secret) {
        long value = new Date().getTime() / TimeUnit.SECONDS.toMillis(30);

        MyBase32 base = new MyBase32(MyBase32.Alphabet.BASE32, false, true);
